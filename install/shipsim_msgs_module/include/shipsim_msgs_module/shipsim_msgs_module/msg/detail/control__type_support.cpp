...
{
  new (message_memory) shipsim_msgs_module::msg::Control(_init);
}

void Control_fini_function(void * message_memory)
{
  auto typed_message = static_cast<shipsim_msgs_module::msg::Control *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Control_message_member_array[2] = {
  {
    ...
    offsetof(shipsim_msgs_module::msg::Control, n_p),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(shipsim_msgs_module::msg::Control, rudder_angle_degree),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Control_message_members = {
  "shipsim_msgs_module::msg",  // message namespace
  "Control",  // message name
  2,  // number of fields
  sizeof(shipsim_msgs_module::msg::Control),
...
{
  return &::shipsim_msgs_module::msg::rosidl_typesupport_introspection_cpp::Control_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, shipsim_msgs_module, msg, Control)() {
  return &::shipsim_msgs_module::msg::rosidl_typesupport_introspection_cpp::Control_message_type_support_handle;
}
